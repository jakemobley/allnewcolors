...
from main.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, ResetRequestForm, ResetPasswordForm
...
def send_reset_email(user):
    ...
    msg = Message('ANC Password Reset Request', sender='noreply@demo.com', recipients=[user.email])
